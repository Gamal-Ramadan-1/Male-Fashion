            ...
            <div class="card-content">
              <div class="card-img-1">
                <div class="content-hover-in-box text-end">
                  ...
                  <a href="#" class="d-block">
                    <i class="fa-duotone fa-code-compare h4 p-1 mx-3"></i>
                  </a>
                  <a href="#" class="d-block">
                    <i class="fa-brands fa-searchengin h4 p-2 mx-3"></i>
                  </a>
                </div>
              </div>
              <div class="card-text">
                <h6>+ add to cart</h6>
                <p class="mt-3 mb-1">Piqué Biker Jacket</p>
                <div class="d-block">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <h5 class="d-inline-block">$67.24</h5>
                  <div class="colors">
                    <div class="purple d-inline-block mx-1"></div>
                    <div class="dark d-inline-block mx-1"></div>
                    <div class="brouwn d-inline-block mx-1"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="box-item">
            <div class="card-content">
              <div class="card-img-3">
                <h6 class="text-capitalize px-3 bg-dark text-light">sale</h6>
                <div class="content-hover-in-box text-end">
                  <a href="#" class="d-block">
                    <i class="fa-solid fa-heart h4 p-2 mx-3 mt-4"></i>
                  </a>
...
.card-img-1 {
  background-image: url("../../imgs/product-1.jpg.webp");
}

.card-img-2 {
  background-image: url("../../imgs/product-2.jpg.webp");
}

.card-img-3 {
  background-image: url("../../imgs/product-3.jpg.webp");
}

.card-img-4 {
  background-image: url("../../imgs/product-4.jpg.webp");
}

.card-img-5 {
  background-image: url("../../imgs/product-5.jpg.webp");
}

.card-img-6 {
  background-image: url("../../imgs/product-6.jpg.webp");
}

.card-img-7 {
  background-image: url("../../imgs/product-7.jpg.webp");
}

.card-img-8 {
  background-image: url("../../imgs/product-8.jpg.webp");
}

.content-hover-in-box {
  right: -10px;
  visibility: hidden;
  position: absolute;
  transition: all 0.3s;
...
.box-item:hover .colors,
.box-item:hover .card-text h6 {
  visibility: visible;
  opacity: 1;
  transition: all 0.3s;
}

.box-item:hover .content-hover-in-box {
  right: 0px;
  visibility: visible;
  opacity: 1;
  transition: all 0.3s;
